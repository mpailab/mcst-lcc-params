...
class Node:
    u'''характеристики узла'''
    def __init__(self):
        # отображение: имя характеристики узла -> значение этой характеристики
        self.chars = {}

class Proc:
    u'''характеристики процедуры на этапе regions'''
    def __init__(self):
...
class Region:
    u'''характеристики региона на этапе regions'''
    def __init__(self):
...
class Icv_Proc:
    u'''характеристики процедуры на этапе if_conv'''
    def __init__(self):
        # отображение: имя характеристики процедуры -> значение этой характеристики
        self.chars = {}
...
class Icv_Region:
    u'''характеристики региона на этапе if_conv'''
    def __init__(self):
        # отображение: имя характеристики региона -> значение этой характеристики
        self.chars = {}
...
class Dcs_level:
    u'''характеристики процедуры на этапе dcs'''
