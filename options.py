...
# Файл с характеристиками процедур, для которых необходимо найти оптимальные значения параметров
TRAIN_PROC_CHARS = None
GL['proc_chars'] = Global(
     'TRAIN_PROC_CHARS', 'proc_chars',
     'файл с характеристиками процедур, для которых необходимо найти оптимальные значения параметров компилятора lcc',
     'path_to_file', None, None, file,
